...
import { Menu, X, ChevronDown, School, BookOpen, GraduationCap, Building } from "lucide-react";
          ...
          <div className="flex items-center justify-between h-16 px-4 sm:px-6">
            ...
            <div className="hidden md:flex md:items-center md:space-x-1">
              ...
              <button
                ...
                className="ml-4 inline-flex items-center px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 rounded-xl shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 cursor-pointer z-50 relative"
              >
                Apply Now
              </button>
            </div>
                ...
                <div className="px-4 py-4 space-y-2 bg-white/50 backdrop-blur-sm">
                  ...
                  <div className="pt-4 pb-2">
                    <button
                      ...
                      className="flex items-center justify-center w-full px-4 py-3.5 text-sm font-bold text-white bg-gradient-to-r from-blue-600 to-cyan-600 rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-200 cursor-pointer"
                    >
                      Apply Now
                    </button>
                  </div>

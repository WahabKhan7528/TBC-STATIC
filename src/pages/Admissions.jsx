    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form className="space-y-6" action="https://formsubmit.co/thebestcollege2008@gmail.com" method="POST">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1" name="fullName">
                  Full Name
                </label>
                <input
                  name="fullname"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1" name="email">
                  Email
                </label>
                <input
                  name="email"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1" name="program">
                Program
              </label>
              <select className="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" name="program">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1" name="message">
                Message
              </label>
              <textarea
                name="message"
